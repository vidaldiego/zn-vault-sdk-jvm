// Path: zn-vault-sdk-jvm/zn-vault-core/src/main/kotlin/com/zincapp/vault/auth/ApiKeyAuth.kt
...
class ApiKeyAuth(
     ...
     *
     * Note: ZnVault uses X-API-Key header, but this is handled specially
